...
import com.netflix.conductor.core.execution.mapper.AMQPWaitTaskMapper;
...
import static com.netflix.conductor.common.metadata.workflow.TaskType.TASK_TYPE_AMQP_WAIT;
...
public class CoreModule extends AbstractModule {
	...
	@ProvidesIntoMap
	@StringMapKey(TASK_TYPE_AMQP_WAIT)
	@Singleton
	@Named(TASK_MAPPERS_QUALIFIER)
	public TaskMapper getAMQPWaitTaskMapper(ParametersUtils parametersUtils, MetadataDAO metadataDAO) {
		return new AMQPWaitTaskMapper(parametersUtils, metadataDAO);
	}
